...
import { ArrowLeft, Calendar, MapPin, Globe, Flag, Clock, DollarSign } from "lucide-react"
...
export default function ItineraryPage() {
  ...
  useEffect(() => {
    ...
    if (place && placeIdParam && fromDateParam && toDateParam) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const itineraryData = await generateItinerary(destination, placeId, fromDate, toDate)
        const weatherData = await fetchWeather(destination, placeId, fromDate, toDate)
        const hotelData = await fetchHotels(destination, placeId)
        const imageData = await fetchImages(destination)
        const budgetData = await getBudgetEstimates(destination, days)
    ...
    fetchData()
  }, [destination, placeId, fromDate, toDate])

  // Mock function to fetch hotels
  const fetchHotels = async (destination: string, placeId: string): Promise<HotelData[]> => {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-xl font-semibold">Planning your perfect trip to {destination}...</h2>
            ...
            <Card className="bg-white p-6 rounded-xl">
              <div className="flex items-center justify-between mb-4">
                <div className="grid grid-cols-3 gap-6 w-full">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg text-center">
                    ...
                    <div className="font-medium">5 nights</div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative pl-8">
                ...
                <div className="mb-8 relative">
                  ...
                  <div className="text-xs uppercase text-green-600 font-semibold mb-1">DEPARTURE</div>
                ...
                <div className="mb-8 relative">
                  ...
                  <div className="text-xs uppercase text-blue-600 font-semibold mb-1">ON THE ROAD</div>
                ...
                <div className="relative">
                  ...
                  <div className="text-xs uppercase text-red-600 font-semibold mb-1">ARRIVAL</div>
                  <div className="font-bold text-lg mb-1">Costa Maya / Mexico</div>
                  <div className="flex items-center text-sm text-gray-500 mb-2">
                    <Calendar className="h-4 w-4 mr-1" />
            ...
            <Card>
              <CardContent className="pt-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {weather.map((day) => (
                    <WeatherDisplay key={day.date.toISOString()} weather={day} />
                  ))}
                </div>
              </CardContent>
            </Card>
